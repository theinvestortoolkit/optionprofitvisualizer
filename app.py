...
# This keeps track of your trade legs when the app refreshes
...
# Use session state for price so it persists
...
with col_chart:
    if st.session_state.legs:
        # Dynamic resizing of chart to include current price
...
with col_table:
    ...
    if st.session_state.legs:
        ...
        # Calculate Cash Flow for Display
        def get_cf(row):
        ...
        display_df = df[['Action', 'Type', 'Strike', 'Net Cash', 'Running Total']].copy()
